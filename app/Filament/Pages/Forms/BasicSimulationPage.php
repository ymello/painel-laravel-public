...
/**
 * Trait BasicSimulationPage – define o schema, ações e geração dos resultados para simulações de imóvel.
 *
...
trait BasicSimulationPage
{
    ...
    protected array $banks = [
        // Defina a lista de bancos conforme desejado
        'itau-personalite' => [
    ...
    protected array $bankExtras = [
        // Defina os extras para cada banco
        'itau-personalite' => [
            'jurosEfetiva' => 10.49,
            'ltv' => 'Até 90%',
