        ...
        return Components\Tabs::make('tabs')
            ...
            ->tabs([
                ...
                Components\Tabs\Tab::make('forms.tabs.property_details')->translateLabel()
                    ->schema([
                        ...
                        Components\TextEntry::make('answers.property_value')
                            ...
                            ->money('BRL'),
                        Components\TextEntry::make('answers.entry_value')
                ...
                Components\Tabs\Tab::make('Perguntas')
                    ->columns(1)
                    ->schema([
                        TextBooleanEntry::make('answers.property_or_loan_in_city')
                            ->label('forms.questions.property_or_loan_in_city')->translateLabel()
                            ->boolean(),
                        TextBooleanEntry::make('answers.has_fgts')
                            ->label('forms.questions.has_fgts')->translateLabel()
                            ->boolean(),
                        TextBooleanEntry::make('answers.has_fgts_with_percent_of_value')
                            ->label('forms.questions.has_fgts_with_percent_of_value')->translateLabel()
                            ->boolean(),
                        TextBooleanEntry::make('answers.live_work_in_city')
